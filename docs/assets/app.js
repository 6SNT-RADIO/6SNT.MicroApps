const COPY = {
  en: {
    ...
    meta: ["Local-first", "No telemetry", "Radio-safe by default"],
    ...
    policyCopy: "The portal can be public while individual app repositories remain private. Binaries should be distributed only through each app release channel or a dedicated distribution repository.",
    details: "Details",
    release: "Release",
    repo: "Repository",
    accessNote: "Access may be restricted for private-source tools.",
    sha: "SHA256",
  ...
  es: {
    ...
    meta: ["Local-first", "Sin telemetria", "Radio-safe por defecto"],
    ...
    policyCopy: "El portal puede ser publico mientras los repositorios de app siguen privados. Los binarios deben distribuirse solo por releases de cada app o por un repositorio dedicado de distribucion.",
    details: "Detalles",
    release: "Release",
    repo: "Repositorio",
    accessNote: "El acceso puede estar restringido en herramientas con fuente privada.",
    sha: "SHA256",
    features: "Que hace",
